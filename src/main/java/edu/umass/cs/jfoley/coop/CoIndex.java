...
public class CoIndex {
  public static class Builder implements Closeable, Flushable {
    ...
    private final SortingIOMapWriter<String, Integer> namesWriter;
    private final SortingIOMapWriter<Integer, String> namesRevWriter;
    ...
    public void addDocument(String name, String text) throws IOException {
      ...
      namesWriter.add(name, currentId);
      namesRevWriter.add(currentId, name);
